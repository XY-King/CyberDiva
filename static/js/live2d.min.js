...
L2DTargetPoint.prototype.update = function () {
  ...
  {
    var max_v =
      0.5 * (Math.sqrt(MAX_A * MAX_A + 16 * MAX_A * d - 8 * MAX_A * d) - MAX_A);
    var cur_v = Math.sqrt(
        ...
        thisRef.loadTexture(i, texPaths, function () {
          if (thisRef.isTexLoaded) {
            ...
            if (thisRef.modelSetting.getPhysicsFile() != null) {
              thisRef.loadPhysics(
                thisRef.modelHomeDir + thisRef.modelSetting.getPhysicsFile()
              );
            } else {
  ...
  this.modelSetting.loadModelSetting(modelSettingPath, function () {
    ...
    thisRef.loadModelData(path, function (model) {
      ...
      if (LAppDefine.TEXURE_CHANGE_MODE == "random") {
        no = parseInt(
          Math.random() * (thisRef.modelSetting.getTextureNum() - 1)
        );
      }
      ...
      var texPaths =
        thisRef.modelHomeDir + thisRef.modelSetting.getTextureFile(no);
